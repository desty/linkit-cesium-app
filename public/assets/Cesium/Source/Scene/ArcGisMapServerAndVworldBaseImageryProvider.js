/*global define*/
define('Scene/ArcGisMapServerAndVworldBaseImageryProvider',[
  '../Core/Cartesian2',
  '../Core/Credit',
  '../Core/defaultValue',
  '../Core/defined',
   ...
   * var esri = new Cesium.ArcGisMapServerAndVworldBaseImageryProvider({
     ...
     * });
   */
  var ArcGisMapServerAndVworldBaseImageryProvider = function ArcGisMapServerAndVworldBaseImageryProvider(options) {
   ...
   */
  ArcGisMapServerAndVworldBaseImageryProvider.prototype.pickFeatures = function() {
    return undefined;
  };
