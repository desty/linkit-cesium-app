/*global define*/
define('Scene/ArcGisMapServerAndVworldSatelliteImageryProvider',[
  '../Core/Cartesian2',
  '../Core/Credit',
  '../Core/defaultValue',
  '../Core/defined',
   ...
   * var esri = new Cesium.ArcGisMapServerAndVworldSatelliteImageryProvider({
     ...
     * });
   */
  var ArcGisMapServerAndVworldSatelliteImageryProvider = function ArcGisMapServerAndVworldSatelliteImageryProvider(options) {
  ...
  function buildImageUrl(imageryProvider, x, y, level) {
    ...
    if (
      ...
      url = '//xdworld.vworld.kr:8080/2d/Satellite/201301/' + level + '/' + x + '/' + y + '.jpeg';
      //console.log(url);
    }
   ...
   */
  ArcGisMapServerAndVworldSatelliteImageryProvider.prototype.pickFeatures = function() {
    return undefined;
  };
